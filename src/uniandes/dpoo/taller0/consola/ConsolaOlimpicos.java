...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Nombre de un atleta que desea conocer: ");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Se agrega nueva opción para buscar información sobre un atleta:
	 */
	private void ejecutarbuscarAtleta()
	{
		System.out.println("\n"+ "Buscar información sobre un atleta por nombre :" + "\n");
		
		String nombreAtleta=input("Ingresar nombre del atleta que desea conocer: ");
		String nombrePais= calculadora.paisDelAtleta(nombreAtleta);
		
		if (nombrePais !=null)
		{
			System.out.println("El atleta: " + nombreAtleta + "representa al país" + nombrePais + ".");
			
		}
		else
		{
			System.out.println("El atleta: " + nombreAtleta + "no se encontro" );}
		}
