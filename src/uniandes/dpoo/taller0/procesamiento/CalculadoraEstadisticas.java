...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta el nombre del país al cual representa un atleta.
	 * 
	 *@param nombreAtleta El nombre del atleta q.
	 * @return El nombre del país al cual representa el atleta o null si no se encuentra el atleta.
	 */
	public String paisDelAtleta (String nombreAtleta)
	{
		Atleta enconAtleta=buscarAtleta(nombreAtleta);
		
		if (enconAtleta != null)
		{
			return enconAtleta.darPais().darNombre();
